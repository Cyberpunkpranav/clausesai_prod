...
const SelectedClause_Loader = () => {
  return (
    ...
    <h2 className='fw-normal col-3 col-md-5 col-lg-6 placeholder position-absolute heading'></h2>
    </div>
    <div className="col-sm-12 col-md-6 col-lg-7 text-end ps-0 placeholder-glow">
    <p className='fw-normal col-8 text-gray2 text-start text-md-end placeholder'></p>
    </div>
  </div>
