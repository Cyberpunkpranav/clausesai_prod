...
const Login = () => {
  ...
  return (
    <>
    <Helmet>
    <title>Login | Discover exclusive legal clauses</title>
    ...
    <div className="container-fluid loginsection align-items-center d-flex justify-content-center">
            ...
            <div className="col-12 justify-content-center text-center d-flex mx-auto ">
              {
                load?(
                  ...
                  <button className='btn bg-blue2 text-white rounded-2 px-3 py-2'onClick={()=>login()}>Login</button>
                )
              }
            </div>
            <div className="col-12 text-center mt-2">
              <small>New to clausesai? <a href='' onClick={()=>{navigate('/Signup')}}><small>Signup</small> </a> </small>
            </div>
